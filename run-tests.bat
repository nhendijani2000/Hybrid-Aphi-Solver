...
set "TESTS=aphi_tests aphi_tests_equilibration aphi_tests_incidence aphi_tests_gmsh_reader aphi_tests_basis_functions aphi_tests_tree_cotree aphi_tests_gauge_variants aphi_tests_sparse_matrix aphi_tests_problem aphi_tests_input_file"
